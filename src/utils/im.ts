...
import { customMessageType, messageTypes, SessionType, tipsTypes } from "../constants/messageContentType";
import { OpenIMSDK } from "./open_im_sdk";
import { ConversationItem, CustomType, MessageItem } from "./open_im_sdk/types";
...
export const parseMessageType = (pmsg: MessageItem, curUid?: string): string => {
  ...
  switch (pmsg.contentType) {
    ...
    case messageTypes.CUSTOMMESSAGE:
      const data = pmsg.customElem.data;
